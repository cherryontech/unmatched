...
export function ProfessionalsPage({ data, setData, fullDataSet,getFilteredCards}) {
  ...
  return (
    <div>
      ...
      <div className="w-1/2 mx-auto mt-5 mb-3 text-center text-primary max-w-[35%] text-lg">You don’t have to feel like a fraud anymore. <br/>Learn from STEM leaders who overcame imposter syndrome and emerged as trailblazers. Get empowered to do the same.</div>
      <SearchBar
        data={data}
        setData={setData}
