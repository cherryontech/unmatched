...
export default function NavBar() {
  ...
  return (
    <div className="space-x-4">
      ...
      >
        <span className="text-center font-bold md:group-hover:opacity-100 md:text-primary ">
          About Us
        </span>
      ...
      >
        <span className={`md:px-4 md:py-1 ${voiceIconColor} ${voiceIcon}  bg-white  md:bg-clip-border rounded-full md:bg-red-500 md:text-white md:hover:bg-gradient-to-r from-red-500 to-purple-500 text-center font-bold`}>
          Unmatched Voices
        </span>
