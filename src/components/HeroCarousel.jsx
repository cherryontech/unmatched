        ...
        <div className="hero  h-[30rem] lg:h-[35rem] max-h-[100%]  bg-primary">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className='h-[305px] w-[100%] lg:w-[50rem] md:justify-start justify-center lg:text-start text-center sm:h-fit'>
              ...
              <Link onClick={()=>scroll()} className="bg-secondary rounded-full px-4 lg:py-2 p-1 overflow-hidden text-white lg:text-[20px] text-[15px] font-bold hover:bg-gradient-to-r from-red-500 to-purple-500">Learn More</Link>
            </div>
            </div>
          </div>
        ...
        <div className="hero  h-[30rem] lg:h-[35rem] max-h-[100%] bg-primary">
          <div className="hero-content flex-col lg:flex-row-reverse">
            ...
            <div className='h-[305px] w-[80%] lg:w-[50rem] sm:h-fit md:justify-start lg:text-start  justify-center text-center '>
              ...
              <p className="py-1 text-white text-[16px] w-[97%] lg:text-[21px] lg:w-[85%]">Uncover stories of STEM leaders who’ve overcome imposter syndrome and fostered a more inclusive STEM community. </p>
              <p className="py-1 text-white text-[16px] w-[97%] lg:text-[21px] lg:w-[85%]"> Find strength and inspiration as you navigate your own STEM path. </p>
              <div className='mt-[2rem]'>
              <Link onClick={()=>scroll()} className="bg-secondary rounded-full px-4 lg:py-2 p-1 overflow-hidden text-white lg:text-[20px] text-[15px] font-bold hover:bg-gradient-to-r from-red-500 to-purple-500">Learn More</Link>
            </div>
            </div>
