...
const Card = props => {
  ...
  return (
    <>
      <h1 className="text-[30px] font-bold text-center mt-12 text-[#0A2E50]">
        You are in good company
      </h1>
      <form className=" w-full m-auto max-w-lg mt-2 relative">
        <label className="label">
          <span className="label-text-alt flex items-start text-[#0A2E50] font-bold">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Who can we help you find"
