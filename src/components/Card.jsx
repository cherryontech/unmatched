...
const Card = ({ data, setData, getFilteredCards }) => {
  ...
  return(
  <FilterButton tag= {button.name} getFilteredCards ={getFilteredCards} name = {button.name} id={button.id} key={button.id} changeButtonColor={changeButtonColor} 
