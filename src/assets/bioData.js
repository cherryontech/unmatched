...
export const bioData = [
  {
    ...
    bio: {
      summary: `Reshma Saujani is a renowned activist and author committed to empowering women and girls, bridging the tech gender gap, and advocating for moms. She is best known as the founder of <i>Girls Who Code</i>, a non-profit organization closing the tech gender gap by offering girls, women, and nonbinary people access to programming education.
  ...
  },
  {
    ...
    bio: {
      ...
      impact: `Marquez has expressed her advocacy for STEM inclusion, marine conservation, and science education through interviews, TEDx, contributions to  <span style='font-weight:280'><i>Forbes Science</i></span></span>, and Shark Week and other TV programming. \n Her podcast  <span style='font-weight:280'><i>ConCiencia Azul</i></span> highlights Spanish-speaking marine scientists and enthusiasts from around the world as well as some of the major barriers Latin American countries face. Marquez’s live #STEMSaturdays on X and her work with femSTEM offer career advice to women scientists. \n Marquez founded the nonprofit The Fins United Initiative (TFUI) to provide accessible information on Chondrichthyans, dispel stigmas about them, and promote their conservation and awareness. TFUI’s Chondrichthyan education and conservation program has reached schools across 12 countries and the U.S.`,
    },
    resources: [
      {
        title:
